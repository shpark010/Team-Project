$(function() {
    var kind = ['카타르 월드컵','카타르 월드컵 골영상','카타르 월드컵 하이라이트'];
    var select = "";
    if($('#all').click) {
        select = kind[0];
    }else if($('#goal').click) {
        select = kind[1];
    }else if($('#highlight').click) {
        select = kind[2];
    }
...
function fnGetGoalList(sGetToken){
    
    var $getval="카타르 월드컵 골영상";
...
function fnGetHighlihgtList(sGetToken){

    var $getval="카타르 월드컵 하이라이트";
