	...
	<!-- 헤더 영역 시작 -->
		<div class="container">
			...
			<a class="site-logo" href="${contextPath}/main.do">
				<img src="${contextPath}/resources/img/logo2.png" class="headlogo" alt="">
			</a>
			<div class="user-panel">
			<c:choose>
					<c:when test="${isLogOn == true && member != null}">
						<p>${member.id}님</p>&nbsp&nbsp&nbsp/&nbsp&nbsp&nbsp
						<a href="${contextPath}/views/member/mypage.jsp" style="cursor: pointer;">마이페이지</a>&nbsp&nbsp&nbsp/&nbsp&nbsp&nbsp
