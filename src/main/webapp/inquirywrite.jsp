...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="img/inquwritebg.jpg">
		<div class="pi-content">
			<div class="container"> 
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2 style="color: #000; font-weight: bold;">문의게시판</h2>
					</div>
				</div>
			</div>
		</div>
			  ...
			  <!--로그인/회원가입 부분 종료 -->
				...
				<div class="col-lg-12">
					<div class="contact-form-warp">
						...
						<form action="" method="get" class="comment-form" autocomplete="off">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-lg-12">
									<input type="text" name="q_title" placeholder="제목" autocomplete="off">
									<textarea name="q_content" placeholder="내용" autocomplete="off"></textarea>
									<input type="submit" class="site-btn btn-sm" style="font-weight: bold;" value="글쓰기">
								</div>
							</div>
						</form>
					</div>
