...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="img/page-top-bg/h_3.jpg">
		<div class="pi-content">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>경기 영상</h2>
						<p>세계적인 선수들의 경기별 하이라이트를 영상으로 만나보세요</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="page-section review-page spad">
		...
		<div class="selectV container" >
			<form name="form1" method="post" onsubmit="return false;">
				<button class="btn_v" id="all" onclick="find('카타르 월드컵');">전체</button>
				<button class="btn_v" id="goal" onclick="find('카타르 월드컵 골영상');">골영상</button>
				<button class="btn_v" id="highlight" onclick="find('카타르 월드컵 하이라이트');">하이라이트</button>
			</form>
		</div>
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="footer-logo text-white">
					...
					<p>Project Teams</p>
					<div class="inquiry" style="padding-left: 90px;">
